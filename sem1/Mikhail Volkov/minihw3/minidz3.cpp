...
int main() {
    ...
    while (true) {
        ...
        case 2:        
            ...
            break;
        case 3:        
            std::cout << "Average price in the tire store: " << tires.getAveragePrice() << '\n';
            std::cout << "Average weight in the tire store: " << tires.getAverageWeight() << '\n';        
            break;
        }   
        std::cout << "\n\n";
    }
